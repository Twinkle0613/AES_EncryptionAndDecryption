...
void test_customTestAssertEqualState_actState_is_a_NULL(void){
...
void test_customTestAssertEqualState_expState_is_a_NULL(void){
...
void test_customTestAssertEqualState_given_str_array_that_should_return_true(void){
...
void test_customTestAssertEqualState_given_hec_array_that_should_return_true(void){
...
void test_customTestAssertEqualState_given_hec_and_str_array_that_should_return_true(void){
