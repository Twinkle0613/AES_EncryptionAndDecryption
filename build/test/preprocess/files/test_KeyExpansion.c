...
void test_keyExpansion_given_128_bit_cipher_key(void){
 ...
 printf("No7.0 - keyExpansion 128-bit cipher key\n");
  ...
  UnityAssertEqualNumber((_U_SINT)(_UU32)((0xb6630ca6)), (_U_SINT)(_UU32)((word[43])), (((void *)0)), (_U_UINT)125, UNITY_DISPLAY_STYLE_UINT32);

  UnityAssertEqualNumber((_U_SINT)(_UU32)((0xac7766f3)), (_U_SINT)(_UU32)((word[36])), (((void *)0)), (_U_UINT)126, UNITY_DISPLAY_STYLE_UINT32);

  UnityAssertEqualNumber((_U_SINT)(_UU32)((0x110b3efd)), (_U_SINT)(_UU32)((word[25])), (((void *)0)), (_U_UINT)127, UNITY_DISPLAY_STYLE_UINT32);
...
void test_keyExpansion_given_192_bit_cipher_key(void){
 ...
 printf("No8.0 - keyExpansion 192-bit cipher key\n");
  ...
  UnityAssertEqualNumber((_U_SINT)(_UU32)((0xad07d753)), (_U_SINT)(_UU32)((word[43])), (((void *)0)), (_U_UINT)142, UNITY_DISPLAY_STYLE_UINT32);
...
void test_keyExpansion_given_256_bit_cipher_key(void){
 ...
 printf("No9.0 - keyExpansion 256-bit cipher key\n");
  ...
  UnityAssertEqualNumber((_U_SINT)(_UU32)((0x9ba35411)), (_U_SINT)(_UU32)((word[8])), (((void *)0)), (_U_UINT)158, UNITY_DISPLAY_STYLE_UINT32);

  UnityAssertEqualNumber((_U_SINT)(_UU32)((0x98312229)), (_U_SINT)(_UU32)((word[22])), (((void *)0)), (_U_UINT)159, UNITY_DISPLAY_STYLE_UINT32);

  UnityAssertEqualNumber((_U_SINT)(_UU32)((0xde136967)), (_U_SINT)(_UU32)((word[40])), (((void *)0)), (_U_UINT)160, UNITY_DISPLAY_STYLE_UINT32);

  UnityAssertEqualNumber((_U_SINT)(_UU32)((0x706c631e)), (_U_SINT)(_UU32)((word[59])), (((void *)0)), (_U_UINT)161, UNITY_DISPLAY_STYLE_UINT32);
